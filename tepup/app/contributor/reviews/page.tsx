        ...
        <div className="space-y-3">
          {contributions.map((contribution) => {
            ...
            return (
              <Link
                key={contribution.id}
                href={`/contributor/reviews/${contribution.id}`}
                className="block bg-white rounded-xl border border-gray-100 p-5 hover:shadow-sm hover:border-teal-200 transition-all"
              >
